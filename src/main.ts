...
let prevColor: vec4 = [ 255, 255, 255, 255 ]
let timer = 0
...
function main() {
  ...
  function tick() {
    ...
    if(controls.color != prevColor)
    {
      ...
      noise.setGeometryColor(vec4.fromValues(controls.color[0] / 255, controls.color[1] / 255, controls.color[2] / 255, controls.color[3] / 255));
